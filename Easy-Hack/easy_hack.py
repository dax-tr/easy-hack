...
secenek1 = 1
secenek2 = 2
int(input("Lütfen İşleminizi Seçiniz : "))
if secenek1 == 1:
	os.system("clear")
print("""
	1- Dnsenum
...
info = int(input("Lütfen İşleminizi Seçiniz : "))
if info == 1:
	os.system("clear")
...
if info == 6:
	os.system("clear")
	mac = input("MAC Adresini Giriniz : ")
	channel = input("Channel Sayısını Giriniz : ")
	os.system("clear")
...
print("""
	...
	4- Anonim Tarama
		""")
nmap = int(input("Lütfen Tarama Türünü Seçiniz : "))
if nmap == 1:
