...
programlar = input("'\033[92m'Programlar yüklensin mi ? E/h : ")
if  programlar == "E" or "e":
	...
	exit()
güncelleme = input("'\033[92m'İşletim sisteminiz güncellensin mi ? E/h : ")
...
while True:
	...
	print("Programlar başarı ile yüklenmiştir.")
	quit()
